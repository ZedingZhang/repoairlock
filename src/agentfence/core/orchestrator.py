...
from agentfence.sandbox.base import RunResult as SandboxRunResult
...
@dataclass
class RunConfig:
    """User-facing configuration for a single `agentfence run` invocation."""
...
class RunOrchestrator:
    ...
    def execute(self, config: RunConfig) -> RunResultSummary:
        """Run the complete Tier 0 pipeline. Raises AgentFenceError on failure."""
