...
from agentfence.exceptions import (
    EnvironmentError,
)
from agentfence.sandbox.base import (
    RunResult,
    SandboxBackend,
    SandboxConfig,
)
from agentfence.sandbox.command_builder import build_docker_run_args
from agentfence.sandbox.resource_monitor import ResourceSampler
...
class DockerBackend(SandboxBackend):
    ...
    def run(self, config: SandboxConfig) -> RunResult:
        ...
        container_name = f"agentfence-{config.run_id}"
