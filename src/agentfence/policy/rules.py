...
from agentfence.policy.models import PolicyResult, PolicyRule
...
def evaluate_docker_config(
    ...
    *,
    ...
    This is the Tier 0 enforcement point: AgentFence's own Docker
    ...
    if rule.match.flag:
        ...
        if rule.match.flag == "--pid host":
            return PolicyResult.not_matched(rule)  # never set by AgentFence
